...
$(document).ready(function() {
	...
	$(".channel img:first").click(function(event) {
		uuid = $(this).data('uuid');
		console.log(uuid);
		$(this).removeClass('channel').addClass('channel-selected');
		$(".channel-selected").addClass('channel').removeClass('channel-selected');
	});
